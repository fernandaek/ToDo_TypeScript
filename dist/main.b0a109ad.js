...
exports.Todo = Todo;
},{}],"src/services/serviceTodo.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  ServiceTodo.prototype.getTodo = function () {
    var items = [{
      "Text": "Learn TypeScript",
      "IsCompleted": false
    }, {
      "Text": "Boost JavaScript",
      "IsCompleted": true
    }, {
      "Text": "Learn NodeJs",
      "IsCompleted": false
      ...
      "Text": "Buy new online courses",
      "IsCompleted": false
    }];
    var result = items.map(function (item) {
      return new todo_1.Todo(item.Text, item.IsCompleted);
    });
    return result;
  };
...
},{"../models/todo":"src/models/todo.ts"}],"src/main.ts":[function(require,module,exports) {
"use strict";
...
var serviceTodo_1 = require("./services/serviceTodo");

var todo_1 = require("./models/todo");

window.onload = function () {
  // alert("It's working")
  var main = new Main(new serviceTodo_1.ServiceTodo());
  main.start();
};
...
exports.Main = Main;
},{"./services/serviceTodo":"src/services/serviceTodo.ts","./models/todo":"src/models/todo.ts"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
